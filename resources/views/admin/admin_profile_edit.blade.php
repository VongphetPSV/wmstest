         ...
         <div class="col-12"> 
            <div class="card">
               <div class="card-body">
                     ...
                     <h4 class="card-title">ແກ້ໄຂຂໍ້ມູນບັນຊີຜູ້ໃຊ້</h4>
                     
                     <form method="post" action="{{ route('store.profile') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                           <label for="example-text-input" class="col-sm-2 col-form-label">ຊື່</label>
                           <div class="col-sm-10">
                        ...
                        <!-- end row -->
                        <div class="row mb-3">
                           <label for="example-text-input" class="col-sm-2 col-form-label">ຊື່ບັນຊີຜູ້ໃຊ້</label>
                           <div class="col-sm-10">
                        ...
                        <div class="row mb-3">
                           <label for="example-text-input" class="col-sm-2 col-form-label">ຮູບ</label>
                           <div class="col-sm-10">
